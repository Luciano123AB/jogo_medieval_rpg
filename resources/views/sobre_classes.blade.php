                    ...
                    <div class="cards sombras card {{ session("tema") == "escuro" ? "bg-secondary border-start border-primary" : "bg-dark border-start border-danger" }} rounded">
                        ...
                        <div class="card-body border-top {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }}">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-secondary" : "bg-dark" }} list-group-item">🎯 Tipo de dano: {{ $personagem->tipo_dano }}</li>
                                <li class="cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-secondary" : "bg-dark" }} list-group-item">➡️ Alcance: {{ $personagem->alcance }} distância</li>
                                <li class="cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-secondary" : "bg-dark" }} list-group-item">❤️ Vida: {{ $personagem->vida }}</li>
                                <li class="cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-secondary" : "bg-dark" }} list-group-item">🔰 Defesa: {{ $personagem->defesa }}</li>
                            </ul>
                        </div>
                        ...
                        <div class="card-body border-top {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }}">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-secondary" : "bg-dark" }} list-group-item">1 - {{ $personagem->skill01?->skill }}</li>
                                <li class="cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-secondary" : "bg-dark" }} list-group-item">2 - {{ $personagem->skill02?->skill }}</li>
                                <li class="cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-secondary" : "bg-dark" }} list-group-item">3 - {{ $personagem->skill03?->skill }}</li>
                            </ul>
                        </div>
                    </div>
                @endforeach
