                    ...
                    <div class="tabelas-scroll">
                        <table class="border border-2 {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} w-100">
                            <thead class="text-center">
                                <th class="titulos_{{ session("tema") }} cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} border px-1"><i class="bi bi-list-ol"></i>Nº</th>
                                <th class="titulos_{{ session("tema") }} cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} border">Player</th>
                            ...
                            <tbody>
                                @forelse ($batalhas as $batalha)
                                    <tr>
                                        ...
                                        <td class="cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} border text-center">
                                ...
                                @empty
                                    <tr class="text-center">
                                        <td colspan="6" class="cor_fontes_{{ session("tema") }}">NENHUMA BATALHA ACONTECENDO NO MOMENTO</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
