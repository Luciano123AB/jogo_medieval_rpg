                ...
                <div class="sombras animate__animated animate__zoomInLeft card {{ session("tema") == "escuro" ? "bg-secondary border-primary" : "bg-black border-danger" }} p-3">
                    ...
                    <form action="{{ route("$rota") }}" method="post" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="card-header border border-2 {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} text-center rounded-top">
                            @if ($pagina == "Cadastro")
                                <i class="bi bi-plus-circle-fill titulos_{{ session("tema") }} cor_fontes_{{ session("tema") }} fs-5"></i>
                            @else
                                <i class="bi bi-arrow-repeat titulos_{{ session("tema") }} cor_fontes_{{ session("tema") }} fs-5"></i>
                            @endif
                            <Label class="titulos_{{ session("tema") }} cor_fontes_{{ session("tema") }} fw-bold fs-5">{{ $titulo }}</Label>
                        </div>

                        <div class="card-body border-start border-2 border-end {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }}">
                            <label class="form-label cor_fontes_{{ session("tema") }}">{{ $pagina == "Cadastro" ? "Usuário" : "Novo Usuário" }}:</label>
                            <div class="mb-3">
                            ...
                            <label class="form-label cor_fontes_{{ session("tema") }}">{{ $pagina == "Cadastro" ? "Email" : "Novo Email" }}:</label>
                            <div class="mb-3">
                                <div class="input-group">
                                    <span class="input-group-text cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-light border-primary" : "bg-dark border-danger" }}">
                            ...
                            <label class="form-label cor_fontes_{{ session("tema") }}">{{ $pagina == "Cadastro" ? "Senha" : "Nova Senha" }}:</label>
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <button type="button" id="mostrar_novo" class="cursor input-group-text cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-light border-primary" : "bg-dark border-danger" }}">
                            ...
                            <label class="form-label cor_fontes_{{ session("tema") }}">{{ $pagina == "Cadastro" ? "Confirmar Senha" : "Confirmar Nova Senha" }}:</label>
                            <div class="mb-3">
                                <div class="input-group">
                                    <span class="input-group-text cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-light border-primary" : "bg-dark border-danger" }}">***</span>
                                    ...
                                    <button type="button" id="mostrar_confirmar_novo" class="cursor input-group-text cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-light border-primary" : "bg-dark border-danger" }}">
                                        <i class="cursor bi bi-eye-slash-fill"></i>
                                    </button>
                                </div>
                            ...
                            <div class="overflow-x-auto">
                                @if($pagina != "Atualização")
                                    <div class="d-flex gap-3">
                                        <div class="border-end {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} mb-3 pe-3">
                                            <label class="form-label cor_fontes_{{ session("tema") }}">Gênero:</label>
                                        ...
                                        <div class="w-50">
                                            <label class="form-label cor_fontes_{{ session("tema") }}">País:</label>
                                            <div class="mb-3">
                                                <div class="input-group">
                                                    <span class="input-group-text cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-light border-primary" : "bg-dark border-danger" }}">
                                ...
                                <div class="d-flex gap-3 mb-3">
                                    <div class="d-flex gap-3">
                                        <div>
                                            <label class="form-label cor_fontes_{{ session("tema") }}">{{ $pagina == "Cadastro" ? "Classe" : "Nova Classe" }}:</label>
                                            <div class="input-group">
                                                <span class="input-group-text cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-light border-primary" : "bg-dark border-danger" }}">
                                                    <i class="bi bi-sort-down"></i>
                                                </span>
                                        ...
                                        <div class="border-end {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} pe-3">
                                            <label class="form-label cor_fontes_{{ session("tema") }}">
                                        ...
                                        <div>
                                            <label class="form-label cor_fontes_{{ session("tema") }}">{{ $pagina == "Cadastro" ? "Foto (Opcional)" : "Nova Foto (Opcional)" }}:</label>
                                            <div class="d-grid">
                                                <div class="input-group">
                                                    <span class="input-group-text cor_fontes_{{ session("tema") }} {{ session("tema") == "escuro" ? "bg-light border-primary" : "bg-dark border-danger" }}">
                                                ...
                                                @if($pagina == "Atualização")
                                                    <div class="form-check mt-2">
                                                        ...
                                                        <label class="form-check-label" for="sem_foto">
                                                            <span class="cursor cor_fontes_{{ session("tema") }}">Sem Foto</span>
                                                        </label>
                                                    </div>
                                                @endif
                                            </div>
